...
public:
    ...
    void CopyTextureRegion(GpuResource& Dest, UINT x, UINT y, UINT z, GpuResource& Source, const RECT* rect = nullptr);
...
inline void CommandContext::CopyTextureRegion(GpuResource& Dest, UINT x, UINT y, UINT z, GpuResource& Source, const RECT* pRect)
{
    TransitionResource(Dest, D3D12_RESOURCE_STATE_COPY_DEST);
    ...
    if (pRect != nullptr)
    {
        ...
        m_CommandList->CopyTextureRegion(&destLoc, x, y, z, &srcLoc, nullptr);
